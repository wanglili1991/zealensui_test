...
interface IUserMethods {
    ...
    void setCallback(@NonNull VideoCallback callback);

    void setProgressCallback(@NonNull EasyVideoProgressCallback callback);

    void setLeftAction(@VideoPlayer.LeftAction int action);

    void setRightAction(@VideoPlayer.RightAction int action);
